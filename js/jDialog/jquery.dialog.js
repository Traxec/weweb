...
var jDialog = (function($, undefined){
    ...
    var _alert = function(content,button,options){
        ...
        options = $.extend({
            ...
            title : options.title ? options.title : '<div style="height:30px;border-bottom:1px solid #f8bdbf;"><span style="margin-left:30%;color:#f2343b;font-size:16px;margin-bottom:20px;">温馨提示</span></div>'
        });
